...
exports.checkIfCardIsActivated = exports.recharge = void 0;
const rechargeRepository = __importStar(require("../repositories/rechargeRepository"));
const recharge = (id, amount) => __awaiter(void 0, void 0, void 0, function* () {
    yield rechargeRepository.insert({ cardId: id, amount });
});
